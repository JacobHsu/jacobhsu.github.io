...
export const defaultCategories: Category[] = [
  ...
  },
  {
    ...
    bookmarks: [
      {
        id: "greatfrontend-system-design",
        title: "GreatFrontEnd System Design",
        url: "https://www.greatfrontend.com/front-end-system-design-playbook",
        quotaInfo: "前端系統設計教學手冊",
      },
      {
        id: "hellointerview",
        title: "Hello Interview",
        url: "https://www.hellointerview.com/",
        quotaInfo: "系統設計面試準備平台",
      },
      {
        id: "system-design-gpt",
        title: "System Design GPT",
        url: "https://chatgpt.com/g/g-hdVziaooT-system-design-gpt",
        quotaInfo: "系統設計 AI 問答助手",
      },
      {
        id: "excalidraw",
        title: "Excalidraw",
        url: "https://excalidraw.com/",
        quotaInfo: "手繪風格白板工具，免費使用",
      },
    ],
  },
  {
